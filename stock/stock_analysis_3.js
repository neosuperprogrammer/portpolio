...
(function () {
      ...
      sequence = sequence
        .then(function () {
          return new Promise(function (resolve, reject) {
            ...
            var domestic = common.getDomesticInvestigation(companyInfo, 10);
            var foreign = common.getForeignInvestigation(companyInfo, 10);
            ...
            if (foreign > 0 && foreign + domestic > 0) {
              ...
              //}
              if (companyInfo.eps > 0 && common.getInvestigationAmount(companyInfo, 10) > 5000) {
                foundedCompanies.push(companyInfo);
              }
            }
            resolve(companyInfo);
  ...
  initialize()
    ...
    .then(function (companies) {
      ...
      foundedCompanies.sort(function (a, b) {
        return common.getInvestigationAmount(b, 10) - common.getInvestigationAmount(a, 10);
      });
