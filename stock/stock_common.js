...
module.exports = {
  ...
  getInvestigationAmount: function (companyInfo, limit) {
    var domestic = this.getDomesticInvestigation(companyInfo, limit);
    var foreign = this.getForeignInvestigation(companyInfo, limit);
